...
plot.pop.all <- function(prms, res, plotfp){
  plot(NA,
       xlim=c(1,prms$ngens),
       #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
       ylim=c(0,max(rowSums(res[, 'num.f', ]),rowSums(res[, 'num.m', ]),rowSums(res[, 'num.r', ]))),
...
plot.pop.patch <- function(patch, prms, res, plotfp){
  
  if(dir.exists(sprintf('%s/pops',plotfp))==FALSE){
    system(paste0('mkdir ',plotfp,'/pops'))
  }
  ...
  pdf(file=sprintf('%s/pops/pop_patch_%s_plot.pdf',plotfp,patch), width=5, height=5)
  plot(NA,
       xlim=c(1,prms$ngens),
       #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
       ylim=c(0,1000),
...
plot.pop.tcosts <- function(patch, prms, tcostarr, species, sep, plotfp){
  ...
  if(dir.exists(sprintf('%s/total_costs',plotfp))==FALSE){
    system(paste0('mkdir ',plotfp,'/total_costs'))
  }
  
  if(sep == 'y'){
    if(species == 'Mercenaries'){
      pdf(file=sprintf('%s/total_costs/cost_%s_on_farmers_patch_%s_plot.pdf',plotfp,species,patch), width=5, height=5)
      plot(NA,
      ...
      pdf(file=sprintf('%s/total_costs/cost_%s_on_raiders_patch_%s_plot.pdf',plotfp,species,patch), width=5, height=5)
      plot(NA,
           xlim=c(1,(prms$ngens-1)),
    ...
    if(species == 'Raiders'){
      ...
      pdf(file=sprintf('%s/total_costs/cost_%s_on_mercs_patch_%s_plot.pdf',plotfp,species,patch), width=5, height=5)
      plot(NA,
           xlim=c(1,(prms$ngens-1)),
  ...
  if(species == 'Mercenaries'){
    pdf(file=sprintf('%s/total_costs/cost_%s_patch_%s_plot.pdf',plotfp,species,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
...
plot.pop.comp.costs <- function(patch, prms, ccostarr, orig.prms, mod.prms, sep, movavg, plotfp){
  ...
  if(dir.exists(sprintf('%s/component_costs',plotfp))==FALSE){
    system(paste0('mkdir ',plotfp,'/component_costs'))
  }
  ...
  if(sep == 'y'){
    pdf(file=sprintf('%s/component_costs/component_cost_%s%s_on_farmers_patch_%s_plot.pdf',plotfp,mod_par_names_str,mod_par_str,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
    ...
    pdf(file=sprintf('%s/component_costs/component_cost_%s%s_on_mercs_patch_%s_plot.pdf',plotfp,mod_par_names_str,mod_par_str,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
    ...
    pdf(file=sprintf('%s/component_costs/component_cost_%s%s_on_raiders_patch_%s_plot.pdf',plotfp,mod_par_names_str,mod_par_str,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
  ...
  if(sep == 'n'){
    pdf(file=sprintf('%s/component_costs/component_cost_%s%s_patch_%s_plot.pdf',plotfp,mod_par_names_str,mod_par_str,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
...
plot.pop.growth <- function(patch, prms, growtharr, sep, plotfp){
  ...
  if(dir.exists(sprintf('%s/pop_growth',plotfp))==FALSE){
    system(paste0('mkdir ',plotfp,'/pop_growth'))
  }
  
  
  if(sep=='y'){
    pdf(file=sprintf('%s/pop_growth/growth_farmers_patch_%s_plot.pdf',plotfp,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
         #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
         #ylim=c(-50,50),
    ...
    pdf(file=sprintf('%s/pop_growth/growth_mercs_patch_%s_plot.pdf',plotfp,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
         #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
    ...
    pdf(file=sprintf('%s/pop_growth/growth_raiders_patch_%s_plot.pdf',plotfp,patch), width=5, height=5)
    plot(NA,
         xlim=c(1,(prms$ngens-1)),
         #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
         #ylim=c(-50,50),
  ...
  pdf(file=sprintf('%s/pop_growth/growth_patch_%s_plot.pdf',plotfp,patch), width=5, height=5)
  plot(NA,
       xlim=c(1,(prms$ngens-1)),
       #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
...
comp_costplot.splines <- function(cost_fp, patch, plotfp){
  ...
  pdf(file=sprintf('%s/component_costs/compcost_splines_%s_patch_%s_plot.pdf',plotfp,mod_par_names_str,patch), width=5, height=5)
  plot(t, y, xlim=c(1,length(t)),
       #ylim=c(0,max(res[,c('num_f.p1','num_m.p1','num_r.p1')])+5),
